	...
	<body>
		<div id="Form">
			...
			<form method="post" action="index.php" name="contract" >
				<div id="nam">
					<p>Im9:<input maxlength="25" size="40" name="name" placeholder="First name Last Name"></p>
				</div>
				<div id="address">
				...
				<p>	<label for='sverh[]'>Supervozmojnosti:</label></br>
					...
					<textarea cols="40" rows="4" name="biography" placeholder="Vasha biografi9..."></textarea>
					<p>Najmi galochky esli lubish Mamochky:
